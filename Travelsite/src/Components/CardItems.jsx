...
import tajmahal from "../assets/4.jpg";
  ...
  return (
    <section id="plan">
      <div className="py-20 flex flex-col gap-20 ">
        ...
        <div className="flex gap-10 justify-evenly flex-wrap px-2">
          {Data.map((item) => (
            <div className="w-[350px] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" key={item.id}>
              <a href="#">
                <img
